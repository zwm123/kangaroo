...
public class OrderBean {
    ...
    public static class OrderInfoBean {
        /**
         * order_No : 25006092712345
         * order_no : 25006092712345
         * user_id : 25856023
         * user_name : 融七牛
         * user_mobile : 18866688866
         * application_amount : 8000.00
         * application_term : 180
         * status : 170
         * order_time : 1500312345
         * city : 杭州
         * bank : 浙江禅文投资管理有限公司-全国
         * product : 赚钱快
         * product_id : 10262233
         */
    ...
    public static class ApplyDetailBean {
        /**
         * bureau_user_name : 融七牛
         * user_id : 110108199009112345
         * application_amount : 8000.00
         * is_op_type : 4
         * loan_apply_term : 180
         * asset_auto_type : 1
         * max_monthly_repayment : 1500
         * user_income_by_card : 0
         * user_education : 3
         * user_social_security : 1
         * work_period : 3
         * phone_number_house : 18866688866
         * credit_status : 2
         * asset_house_type : 5
         * if_social_security : 0
         * monthly_average_income : 5000
         * if_provident_fund : 1
         * platform : ios
         * device_num : 69DC83FF-C53A-482B-BB99-F22
         * ip_address : 60.177.36.83
         * tele_num : 46002
         * tele_name : 中国移动
         * phone_brand : apple
         * device_info : iPhone 7
         * gps_location : 120.14636067327,30.279402017608
         * GPS_Address : 中国浙江省杭州市上城区紫阳街道飞云江路88号
         */
        ...
        private int loan_apply_term;
        private String asset_auto_type;
        private float max_monthly_repayment;
        private float user_income_by_card;
        ...
        private String if_social_security;
    ...
    public static class AddInfoBean {
        ...
        public static class EcBean {
             ...
             * redeemed_points : 0
             * rewarded_points : 0
             * orig_mail_header : Received: from mail.bocomcc.com (unknown [58.246.136.173])\r\n\tby newmx103.qq.com (NewMx) with SMTP id \r\n\tfor <365362024@qq.com>; Fri, 26 Aug 2016 00:08:16 +0800\r\nX-QQ-FEAT: 2Rmh\/KmsIng9KQj8o4Xv8TeL1\/e9\/db\/snYTBKG09A8TFIVw2OG2VEJlTpY8G\r\n\tNWI\r\nX-QQ-MAILINFO: N5kFcZDRcyD886j7zpon\/TP2u51t6UdUt9kRlY1n8lQWO5IW7X7VTvO1G\r\n\tI19LXJ\/ivgL+8p+Kca0vb2+XfYKoIdMQxJ9AQV19fMSO+80IEW5C1IPKx15J7qse9dGM+zz\r\n\t9g+s0tvjkZ8rPYLV\/pIXi9l3f5W4RzSym\/aYh5A7y8Q1l4OAgMWJt9XUG3rI8+CtXiMAV+U\r\n\twJQ15\r\nX-QQ-mid: mx103t1472141297t23qcmml5\r\nX-QQ-CSender: pccc.bill@bocomcc.com\r\nX-QQ-ORGSender: pccc.bill@bocomcc.com\r\nReceived: from mail.bocomcc.com([182.180.47.18])\r\n\tby mail.bocomcc.com(KBAS Gateway 2.1 2.127s39k(2009-10-15),182.180.101.163) with ESMTP id mx15719.1472141296 for <365362024@qq.com>;\r\n\tFri, 26 Aug 2016 00:08:17 +0000 (CST)\r\nX-Original-MailFrom: pccc.bill@bocomcc.com\r\nDKIM-Signature: v=1; a=rsa-sha256; q=dns\/txt; c=simple\/simple; d=bocomcc.com; s=default;\r\n\th=Message-ID:Content-Transfer-Encoding:Content-Type:MIME-Version:Date:To:Subject:From; bh=rFBeCCPIOFRNDhxlFnpczurMQuzRLYynm61jbTDD8A8=;\r\n\tb=wvGl8f0IRaikF+tuR1sFxTAtZ\/4alTa0vC1WuLM\/D0NiErSVnwKiLj\/a5xzJDTKkmK9OxcWdbjwgqEN3rJhTURprpEHBniaiSVpuRdoYj19NL5VdG2WnHJdWMayQyfiuZ\/xtEntrLWmQoXo60cTzJDFC3jddiTQWIKHu19dU1gQ=;\r\nReceived: from mail.bocomcc.com([192.168.1.78])\r\n\tby Postfix with SMTPD id 6327\r\n\tfor <365362024@qq.com>; Fri, 26 Aug 2016 00:08:17 +0800\r\nFrom: =?gbk?B?vbvNqNL40NDMq8a90fPQxdPDv6jW0NDE?= \r\nSubject: =?gbk?B?vbvNqNL40NDQxdPDv6i159fT1cu1pQ==?=\r\nTo: \"=?gbk?B?MzY1MzYyMDI0QHFxLmNvbQ==?=\" <365362024@qq.com>\r\nDate: Fri, 26 Aug 2016 00:07:17 +0800\r\nMIME-Version: 1.0\r\nContent-Type: text\/html; charset=\"gbk\"\r\nContent-Transfer-Encoding: base64\r\nMessage-ID: <1472141296731402@206964>
            ...
            private String orig_mail_header;
            private String time;
            private String create_time;
        ...
        public static class TaobaoBean {
             ...
             * tb_deliver_addrs : [{"tb_user_id":3836225,"receiver_name":"崔文文","area":"北京市","address":"北京市海淀区丹棱街","zip_code":"100000","phone":"13012345678","is_default_address":""},{"tb_user_id":3836225,"receiver_name":"许伟伟","area":"北京 北京市 昌平区 回龙观街道","address":"融泽嘉园1号院6号楼1单元401","zip_code":"000000","phone":"15011111111","is_default_address":"默认地址"},{"tb_user_id":3836225,"receiver_name":"许姐姐","area":"北京市","address":"北京市海淀区丹棱街","zip_code":"100000","phone":"13012345678","is_default_address":""}]
